    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6 font-bangla">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
            <ScrollReveal animation="fade-up" delay={50}>
              <div
                ...
                className="bg-white p-3.5 rounded-2xl border border-slate-100 shadow-2xs card-interactive group"
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <div className="text-[10px] font-medium text-slate-400 leading-tight">অ্যাপয়েন্টমেন্ট</div>
                    <div className="text-lg font-black text-slate-900">{toBn(2)}</div>
            ...
            <ScrollReveal animation="fade-up" delay={100}>
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <div className="text-[10px] font-medium text-slate-400 leading-tight">ই-প্রেসক্রিপশন</div>
                    <div className="text-lg font-black text-slate-900">{toBn(8)}</div>
                    <div className="text-[10px] text-slate-400 font-medium leading-none">মোট সংরক্ষিত</div>
                  </div>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal animation="fade-up" delay={150}>
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <div className="text-[10px] font-medium text-slate-400 leading-tight">ল্যাব রিপোর্ট</div>
                    <div className="text-lg font-black text-slate-900">{toBn(5)}</div>
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <div className="text-[10px] font-medium text-slate-400 leading-tight">রক্তদান সহায়তা</div>
                    <div className="text-lg font-black text-slate-900">{toBn(3)}</div>
          ...
          <ScrollReveal animation="fade-up" delay={150}>
            <div className="bg-white rounded-3xl border border-slate-100 p-5 shadow-xs hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between mb-3.5">
                <h3 className="font-bold text-slate-900 text-sm">আসন্ন ডাক্তার অ্যাপয়েন্টমেন্ট</h3>
                <button
                  onClick={onOpenAppointmentBooking}
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-3.5 rounded-2xl bg-slate-50 border border-slate-100 hover:border-blue-200 transition-all">
                {/* Date Box */}
                <div className="flex items-center gap-3">
                  <div className="bg-white border border-emerald-100 rounded-xl p-2.5 text-center min-w-[68px] shadow-2xs">
                    <div className="text-[10px] font-bold text-slate-500 uppercase">মে</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              <div className="bg-white rounded-3xl border border-slate-100 p-4 sm:p-5 shadow-xs">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-bold text-slate-900 text-sm">সাম্প্রতিক প্রেসক্রিপশন</h3>
                  <button
                    onClick={() => onOpenPrescription()}
                ...
                <div className="space-y-2">
                  {mockPrescriptions.slice(0, 2).map((rx) => (
                    <div
                      key={rx.id}
                      className="p-2.5 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-between hover:bg-blue-50/40 hover:border-blue-200 transition-all"
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <p className="text-xs font-bold text-slate-800 leading-tight">{rx.doctorNameBn}</p>
                          <p className="text-[10px] text-slate-400">{rx.dateBn}</p>
                        </div>
                      </div>
                      <button
                        onClick={() => onOpenPrescription(rx.id)}
                        className="px-2.5 py-1 text-xs font-semibold text-blue-600 bg-white hover:bg-blue-50 border border-blue-200 rounded-lg shadow-2xs btn-press"
                      >
                        দেখুন
                      </button>
                    </div>
            ...
            <ScrollReveal animation="fade-up" delay={250}>
              <div className="bg-white rounded-3xl border border-slate-100 p-4 sm:p-5 shadow-xs">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-bold text-slate-900 text-sm">ল্যাব টেস্ট রিপোর্ট</h3>
                  <button
                    onClick={onOpenReports}
                    className="text-xs font-semibold text-blue-600 hover:underline btn-press"
                  >
                ...
                <div className="space-y-2">
                  {mockLabReports.slice(0, 2).map((rep) => (
                    <div
                      key={rep.id}
                      className="p-2.5 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-between hover:bg-purple-50/40 hover:border-purple-200 transition-all"
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-slate-400">{rep.dateBn}</p>
                        </div>
                      </div>
        ...
        <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-white rounded-3xl border border-slate-100 p-5 shadow-xs hover:shadow-md transition-all">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold text-slate-900 text-sm">লাইভ সিরিয়াল ট্র্যাকার</h3>
                </div>
                <button
                  onClick={onOpenLiveQueue}
              ...
              <div className="flex items-center justify-between p-3 rounded-2xl bg-slate-50 border border-slate-100 mb-3 text-xs">
                <div>
                  <h4 className="font-bold text-slate-900 leading-tight">{primaryAppointment.doctorNameBn}</h4>
                  <p className="text-[11px] text-slate-500">মেডিসিন বিশেষজ্ঞ</p>
                </div>
              ...
              {/* Serial Numbers Grid */}
              <div className="grid grid-cols-3 gap-2 text-center py-2 border-y border-slate-100 my-2">
                <div>
                  <div className="text-[10px] text-slate-400">চলতি সিরিয়াল</div>
                ...
                <div>
                  <div className="text-[10px] text-slate-400">অপেক্ষার সময়</div>
          ...
          <ScrollReveal animation="fade-up" delay={150}>
            <div className="bg-white rounded-3xl border border-slate-100 p-4 sm:p-5 shadow-xs">
              <h3 className="font-bold text-slate-900 text-sm mb-3">দ্রুত অ্যাকশন সেবা</h3>
                ...
                {quickActions.map((qa, i) => {
                  ...
                  if (qa.isTel) {
                    return (
                      <a
                        key={i}
                        href={qa.href}
                        className="flex flex-col items-center justify-center p-2 rounded-xl bg-slate-50 hover:bg-rose-50 border border-slate-100 hover:border-rose-200 card-interactive group"
                      >
                  ...
                  return (
                    <button
                      key={i}
                      onClick={qa.action}
                      className="flex flex-col items-center justify-center p-2 rounded-xl bg-slate-50 hover:bg-blue-50 border border-slate-100 hover:border-blue-200 card-interactive group"
                    >
          ...
          <ScrollReveal animation="fade-up" delay={200}>
            <div className="bg-white rounded-3xl border border-slate-100 p-4 sm:p-5 shadow-xs overflow-hidden">
              <div className="flex items-center justify-between mb-2.5">
                <h3 className="font-bold text-slate-900 text-sm">স্বাস্থ্য টিপস</h3>
