...
export const RegisterModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-200 overflow-y-auto">
      <div className="bg-white dark:bg-slate-900 rounded-3xl max-w-lg w-full shadow-2xl border border-slate-100 dark:border-slate-800 overflow-hidden relative my-6">
        {/* Close Button */}
        <button
        ...
        <div className="p-6 sm:p-7 pb-4">
          ...
          <div className="text-center space-y-1">
            <h2 className="text-xl font-extrabold text-slate-900 dark:text-slate-50 font-bangla">
          ...
          <form onSubmit={handleSubmit} className="mt-5 space-y-4">
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 font-bangla mb-2">
                    ...
                    <button
                      ...
                      className={`p-3 rounded-2xl border text-center transition-all relative flex flex-col items-center justify-center ${
                        isSelected
                          ...
                          : 'border-slate-200 dark:border-slate-800 bg-slate-50/60 hover:bg-slate-50 dark:hover:bg-slate-800/60 text-slate-600 dark:text-slate-400'
                      }`}
                    >
                      {isSelected && (
                      ...
                      <Icon className={`w-5 h-5 mb-1 ${isSelected ? 'text-blue-600' : 'text-slate-500 dark:text-slate-400'}`} />
                      <span className="text-xs font-bold font-bangla block leading-tight">{r.labelBn}</span>
                      <span className="text-[9px] text-slate-400 dark:text-slate-500">{r.labelEn}</span>
                    </button>
                  );
                })}
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800 text-xs font-bangla focus:bg-white dark:bg-slate-900 focus:border-emerald-500 outline-hidden transition-all"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800 text-xs focus:bg-white dark:bg-slate-900 focus:border-emerald-500 outline-hidden transition-all"
                  />
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800 text-xs font-mono focus:bg-white dark:bg-slate-900 focus:border-emerald-500 outline-hidden transition-all"
                  />
                </div>
              </div>
            ...
            {/* Terms checkbox */}
            <label className="flex items-start gap-2 text-xs text-slate-600 dark:text-slate-400 font-bangla cursor-pointer pt-1">
              <input
                type="checkbox"
            ...
            <p className="text-center text-xs text-slate-500 dark:text-slate-400 font-bangla pt-1">
        ...
        <div className="bg-slate-50 dark:bg-slate-800/60 p-4 border-t border-slate-100 dark:border-slate-800 grid grid-cols-3 gap-2 text-center font-bangla">
          <div className="flex flex-col items-center justify-center text-[10px]">
            ...
            <span className="font-bold text-slate-700 dark:text-slate-300">সহজ রেজিস্ট্রেশন</span>
            <span className="text-[9px] text-slate-400 dark:text-slate-500">মাত্র ১ মিনিটে শুরু করুন</span>
          </div>
          <div className="flex flex-col items-center justify-center text-[10px] border-x border-slate-200 dark:border-slate-800">
            ...
            <span className="font-bold text-slate-700 dark:text-slate-300">আপনার তথ্য সুরক্ষিত</span>
            <span className="text-[9px] text-slate-400 dark:text-slate-500">গোপনীয়তা রক্ষা করি</span>
          </div>
          <div className="flex flex-col items-center justify-center text-[10px]">
            <Layers className="w-4 h-4 text-teal-600 mb-0.5" />
            <span className="font-bold text-slate-700 dark:text-slate-300">সব সেবায় এক প্ল্যাটফর্ম</span>
            <span className="text-[9px] text-slate-400 dark:text-slate-500">সবকিছু এক জায়গায়</span>
          </div>
        </div>
      </div>
    </div>
