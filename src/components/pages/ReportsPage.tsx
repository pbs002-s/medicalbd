                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-2">
                      <div>
                        <h4 className="font-bold text-slate-900 text-xs leading-tight">{rep.testName}</h4>
            ...
            <div className="bg-white rounded-3xl border border-slate-100 shadow-md p-6 sm:p-8 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-slate-100 pb-4">
                <div>
                  ...
                  <h2 className="text-xl font-black text-slate-900">{currentReport.testName}</h2>
              ...
              <div className="space-y-3">
                <h3 className="font-bold text-slate-900 text-sm">পরীক্ষার ফলাফল ও রেফারেন্স সীমা (Reference Range)</h3>

                <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200/80 space-y-3">
                  <div className="flex justify-between items-center text-xs">
                    <span className="text-slate-500">ফলাফল ভ্যালু:</span>
                    <strong className="font-mono text-base text-slate-900">{currentReport.resultValue || 'Normal'}</strong>
                  </div>

                  {currentReport.referenceRange && (
                    <div className="flex justify-between items-center text-xs border-t border-slate-200 pt-2">
                      <span className="text-slate-500">স্বাভাবিক রেফারেন্স সীমা:</span>
      ...
      {isUploadOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl border border-slate-100 animate-slide-up">
            <h3 className="text-base font-bold text-slate-900">ল্যাব টেস্ট রিপোর্ট আপলোড</h3>
            <div className="border-2 border-dashed border-slate-300 rounded-2xl p-6 text-center hover:border-blue-500 transition-colors cursor-pointer bg-slate-50">
              ...
              <p className="text-xs font-bold text-slate-700">ফাইল এখানে ড্র্যাগ করুন অথবা ব্রাউজ করুন</p>
              <p className="text-[10px] text-slate-400 mt-1">PDF, JPG, PNG (সর্বোচ্চ ১০ MB)</p>
            </div>
