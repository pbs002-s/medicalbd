  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6 font-bangla">
        ...
        <div className="bg-gradient-to-r from-blue-600 via-indigo-700 to-slate-900 text-white rounded-3xl p-6 sm:p-8 shadow-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            <div className="p-3 bg-white/10 rounded-2xl border border-white/15">
              <span className="text-[11px] text-red-300 font-bold block mb-1">⚠️ চিহ্নিত ড্রাগ এলার্জি (Allergies):</span>
      ...
      <div className="space-y-4">
        <h3 className="font-bold text-slate-900 text-base">কালানুক্রমিক স্বাস্থ্য ইভেন্ট তালিকা</h3>
            ...
            return (
              <ScrollReveal key={evt.id} animation="fade-up" delay={i * 100}>
                <div className="relative group">
                  ...
                  {/* Content Box */}
                  <div className="bg-white rounded-3xl border border-slate-100 p-5 shadow-xs hover:shadow-md hover:border-blue-200 transition-all space-y-2">
                    ...
                    <p className="text-xs text-slate-500">{evt.place}</p>
      ...
      {isAddLogOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl border border-slate-100 animate-slide-up text-xs">
            <h3 className="text-base font-bold text-slate-900">নতুন স্বাস্থ্য রেকর্ড যুক্ত করুন</h3>
            <div>
              <label className="block font-bold text-slate-700 mb-1">রেকর্ডের ধরন:</label>
              <select className="w-full p-2.5 rounded-xl bg-slate-50 border border-slate-200 text-xs">
            ...
            <div>
              ...
              <input type="date" defaultValue="2026-05-20" className="w-full p-2.5 rounded-xl bg-slate-50 border border-slate-200 text-xs font-mono" />
            </div>
            <div>
              <label className="block font-bold text-slate-700 mb-1">বিবরণ:</label>
              <textarea rows={3} placeholder="স্বাস্থ্য ইভেন্টের বিস্তারিত..." className="w-full p-2.5 rounded-xl bg-slate-50 border border-slate-200 text-xs" />
            </div>
            <div className="flex gap-2 pt-2">
              <button onClick={() => setIsAddLogOpen(false)} className="flex-1 py-2 rounded-xl bg-slate-100 text-slate-700 font-bold">
                বাতিল
              </button>
              <button
                onClick={() => {
